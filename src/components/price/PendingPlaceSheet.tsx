...
const PendingPlaceSheet: React.FC<Props> = ({ place, isLoading, onConfirm, onCancel }) => (
    ...
    <View style={styles.detectedWrap}>
      ...
      <View style={styles.detectedCard}>
        ...
        <View style={styles.detectedInfo}>
          <Text style={styles.detectedName} numberOfLines={1}>{place.name}</Text>
          <Text style={styles.detectedAddress} numberOfLines={1}>{place.roadAddress || place.address}</Text>
          {place.category ? (
            <Text style={styles.detectedDist}>{place.category}</Text>
          ) : null}
        </View>
      </View>
      <TouchableOpacity
...
export default PendingPlaceSheet;
